...
<footer class="site-footer" id="about">
  <div class="footer-inner container">
    ...
    <div class="footer-brand">
      ...
      <p class="footer-tagline">Good Finds. Good Prices.<br>Nairobi's trusted electronics marketplace.</p>
    ...
    <div class="footer-col">
      ...
      <ul class="footer-links">
        ...
        <li><a href="<?= APP_URL ?>/shop?shop_location=Shop+1">Shop 1 Items</a></li>
        <li><a href="<?= APP_URL ?>/shop?shop_location=Shop+2">Shop 2 Items</a></li>
      </ul>
    </div>
