...
class SupabaseService(private val context: Context) {
    ...
    suspend fun fetchCustomersFromSupabase(): List<com.example.data.db.entities.CustomerEntity> = withContext(Dispatchers.IO) {
        try {
            val request = Request.Builder()
            ...
            if (response.isSuccessful && body.isNotBlank()) {
                ...
                val list = mutableListOf<com.example.data.db.entities.CustomerEntity>()
                for (i in 0 until array.length()) {
                    val obj = array.getJSONObject(i)
                    list.add(
                        com.example.data.db.entities.CustomerEntity(
                            id = obj.optLong("id"),
    ...
    suspend fun fetchItemsFromSupabase(): List<com.example.data.db.entities.ItemEntity> = withContext(Dispatchers.IO) {
        try {
            val request = Request.Builder()
            ...
            if (response.isSuccessful && body.isNotBlank()) {
                val array = JSONArray(body)
                val list = mutableListOf<com.example.data.db.entities.ItemEntity>()
                for (i in 0 until array.length()) {
                    val obj = array.getJSONObject(i)
                    list.add(
                        com.example.data.db.entities.ItemEntity(
                            id = obj.optLong("id"),
    ...
    suspend fun fetchLoansFromSupabase(): List<com.example.data.db.entities.LoanEntity> = withContext(Dispatchers.IO) {
        try {
            val request = Request.Builder()
            ...
            if (response.isSuccessful && body.isNotBlank()) {
                val array = JSONArray(body)
                val list = mutableListOf<com.example.data.db.entities.LoanEntity>()
                ...
                for (i in 0 until array.length()) {
                    ...
                    list.add(
                        com.example.data.db.entities.LoanEntity(
                            id = obj.optLong("id"),
    ...
    suspend fun fetchTransactionsFromSupabase(): List<com.example.data.db.entities.TransactionEntity> = withContext(Dispatchers.IO) {
        try {
            val request = Request.Builder()
            ...
            if (response.isSuccessful && body.isNotBlank()) {
                val array = JSONArray(body)
                val list = mutableListOf<com.example.data.db.entities.TransactionEntity>()
                for (i in 0 until array.length()) {
                    val obj = array.getJSONObject(i)
                    list.add(
                        com.example.data.db.entities.TransactionEntity(
                            id = obj.optLong("id"),
